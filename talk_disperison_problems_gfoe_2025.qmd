...
::: notes
It is not new that in many scientific areas, there is a large amount of research with false positive rates, that is, when they claim they found a significant result, but this is not true.
Among there are many questionable research practices that may lead to this problem, one that is usually non-intensional is failing in checking models assumptions. In reality, many simply don't even check models and this leads to higher chances of false and unreplicable conclusions. 
This is especially important for generalized linear models and other more complex models, where there are few tools that ecologists may use for models diagnostics.
...
the mean of the distribution is also the variance. That is, if you have lower mean, you have lower variance, but it is not always the case in ecological data
...
- Show some modeling solutions for these causes
...
-   Missing the opportunity to learn and get more info from your data.
